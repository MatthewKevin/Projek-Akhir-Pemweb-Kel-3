...
<head>
	<title>Detail Pembelian | NOVERUKUN</title>
					...
					<div class="products">
						...
						<div class="col-md-12">
							<div class="alert alert-info" role="alert">
								<i class="fa fa-info-circle"></i> Silahkan melakukan pembayaran <b>Rp. <?= number_format($detail['total_pembelian']); ?> BANK BNI 182-098787-2341 AN. Matthew Kevin
								</b>
							</div>
						</div>
						<div class="col-md-12">
							<table class="table">
								...
								<tbody>
									<?php
									$no = 1;
									$query_pembelian_barang = mysqli_query($conn, "SELECT * FROM  tb_pembelian_novel WHERE id_pembelian_novel = $id") or die(mysqli_error($conn));
