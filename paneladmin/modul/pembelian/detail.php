			...
			<div class="row">
				...
				<div class="col-md-12">
					<table class="table">
						...
						<?php 
						$no = 1;
						$pembelian_barang = mysqli_query($conn, "SELECT * FROM tb_pembelian_novel JOIN tb_novel ON tb_pembelian_novel.kd_novel = tb_novel.kd_novel WHERE tb_pembelian_novel.id_pembelian = $id_pembelian") or die(mysqli_error($conn));
