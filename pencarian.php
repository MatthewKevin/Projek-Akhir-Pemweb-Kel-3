...
$keyword = $_GET['keyword'];
 $genreB = "SELECT * FROM tb_novel WHERE kd_novel = '$keyword'";
$semuaData = [];
$ambil = mysqli_query($conn, "SELECT * FROM tb_novel WHERE nama LIKE '%$keyword%'") or die(mysqli_error($conn));
...
<head>
	<title><?= $judulH['nama'] ?> | NOVERUKUN</title>
			...
			<div class="grid-product">
				...
				<?php foreach ($semuaData as $key => $value) : ?>
					<div class="product-grid">
						<div class="content_box"><a href="single.php?id=<?= $value['kd_novel']; ?>">
						...
						<h5><a href="single.php?id=<?= $value['kd_novel']; ?>"><?= $value['nama']; ?></a></h5>
